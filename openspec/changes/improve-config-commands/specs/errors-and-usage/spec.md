# Delta spec: errors-and-usage

## Modified Requirement: Usage Messages for Required Arguments

Replaces the "Cluster patch with no arguments" and "Adapter post-status with no arguments" scenarios with a generalised rule.
